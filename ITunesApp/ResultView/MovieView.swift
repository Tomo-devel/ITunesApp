                ...
                ForEach(viewModel.movieResults!, id: \.self) { result in
                    Button {
                        sample(imageUrl: result.artworkUrl100, smallImageUrl: result.artworkUrl60,
                               trackName:result.trackName, artistName: result.artistName,price: result.trackPrice ?? 0,
                               artistUrl: nil, videoUrl: result.previewUrl, longDescription: result.longDescription,
